...
public class Manager {
    ...
    public static int menu() {
        ...
        System.out.println("11.     Tìm bản ghi có code = 6, sửa lại price=9 và BR");
        System.out.println("12.     Xóa bản ghi có code = 3 (by copying), và BR");
        System.out.println("13.     Không nhập dữ liệu thêm bản ghi (7,G,3,2,1) và BR.");
        System.out.println("14.     Cân bằng (simple balance) cây con gốc 3 và BR.");
...
//        System.out.println("Enter a code: ");
//        String code = Validate.checkInputString();
        Node n = BSTree.search(bt.root, "6");
        if (n == null) {
            System.out.println("Not found");
        } else {
