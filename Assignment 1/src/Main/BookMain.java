...
public class BookMain {
    ...
    public void run() {
        ...
        do {
            menu();
            choice = Validate.checkInputIntLimit(0, 16, "Enter your choice: ");
            switch (choice) {
                case 1:
                ...
                case 8:
                    ...
                    break;
                case 9:
                    int k = Validate.checkInputIntLimit(0, bookList.getLength() - 1, "Enter position to add");
                    bookList.addAfter(k, Validate.getBook());
                    break;
                case 10:
                    int pos = Validate.checkInputIntLimit(0, bookList.getLength() - 1, "Enter position to delete");
